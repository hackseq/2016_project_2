...
- Optimizers being evaluated  
	...
	- [SpearMint](https://github.com/hips/spearmint) by @mgelbart — [Predictive Entropy Search for Multi-objective Bayesian Optimization](https://arxiv.org/abs/1511.05467)
	  - Bayesian method for identifying the Pareto set of multi-objective optimization
problems, when the functions are expensive to evaluate
	...
	- [ParOpt](https://github.com/sseemayer/ParOpt) by @sseemayer 
	  ...
	  - from a starting value, it will call the command line given to it repeatedly, converging into optimal parameters using the Nelder-mead algorithm or grid search
