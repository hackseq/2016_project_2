...
```{r, echo=FALSE, warning=FALSE, message=FALSE, results='hide', fig.height=9}
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE, results='hide', fig.height=10}
...
plotOptimx(optimxResult
    , metricLim=c(0, 20000), p1Lim=c(0, 50)
